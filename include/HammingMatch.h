...
void hammingMatch256ddi(uint32_t *matches, const uint8_t *haystack,
    const uint8_t *needle, const size_t *needle_indices,
...
void hammingMatch256idi(uint32_t *matches, const uint8_t *haystack,
    ...
    size_t num_needle, size_t haystack_base = 0);
...
///    matches[i] = best_match(needle[10]) for haystack index entries
///
void hammingMatch256dii2(uint32_t *matches, const uint8_t *haystack,
    const uint8_t *needle, const size_t *haystack_indices,
    const size_t *needle_indices, size_t num_haystack,
    size_t num_needle, size_t haystack_base = 0);
